...
class FetchProductData:
    ...
    def find_data(self, description, origin,credentials):
        ...
        while(check):
            try:
                ...
                base_url = 'https://www.ralali.com/search/' #ralali search
                ...
                check = True
                pass
        if len(web_soup.findAll('div',{'class':'item-list-cards'})) != 0: #class
    ...
    def fetch_data(self, web_soup, description, origin):
        ...
        list_of_products = web_soup.findAll('item', {'class':'item-grid-style'}) #class
        price_list = web_soup.findAll('b',{'class':'ng-binding'})
            ...
            for Data_from_websites in list_of_products:
                ...
                if price_from_website is not None and price_from_website != '':
                    try:
                        ...
                        product_description = Data_from_websites.find('div',{'class':'item-name'}).text
