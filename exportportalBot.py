...
class FetchProductData:
    ...
    def find_data(self, description, origin,credentials):
        ...
        while(check):
            try:
                ...
                base_url = 'https://www.exportportal.com/search?keywords=' #exportportal search
                ...
                check = True
                pass
        if len(web_soup.findAll('div',{'class':'main-flex-card__float'})) != 0: #class
    ...
    def fetch_data(self, web_soup, description, origin):
        ...
        list_of_products = web_soup.findAll('li',{'class':'products__item'}) #class
        price_list = web_soup.findAll('span',{'class':'products__price-new'})
        ...
        try:
            for Data_from_websites in list_of_products:
                ...
                if price_from_website is not None and price_from_website != '':
                    ...
                    product_description = product_description.lower()
                    product_origin = Data_from_websites.find('div',{'class':'products__seller-country'}).text
