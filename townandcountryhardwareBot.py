...
class FetchProductData:
    ...
    def product_details(self, link, unit_of_measurement, min_order_weight, product_origin, product_description, prices,currency,converted_min_price,converted_max_price):
        ...
        self.product_list.append(
            {'description': product_description,
             ...
             'link': link,
             'website': "townandcountryhardware.com",
    ...
    def find_data(self, description, origin,credentials):
        ...
        while(check):
            try:
                ...
                base_url = 'https://www.townandcountryhardware.com/searchPage.action?keyWord=' #qoovee search
                ...
                check = True
                pass
        if len(web_soup.findAll('div',{'class':'col-md-12'})) != 0: #class
    ...
    def fetch_data(self, web_soup, description, origin):
        ...
        list_of_products = web_soup.findAll('li', {'class':'gridView'}) #class
        price_list = web_soup.findAll('p',{'class':'cimm_priceWrap'})
            ...
            for Data_from_websites in list_of_products:
                ...
                if price_from_website is not None and price_from_website != '':
                    try:
                        ...
                        product_description = Data_from_websites.find('li',{'class':'productDesc'}).text
