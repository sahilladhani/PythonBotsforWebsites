...
class FetchProductData:
    ...
    def find_data(self, description, origin,credentials):
        ...
        while(check):
            try:
                ...
                base_url = 'https://www.like123.com/en/catalogsearch/result/?q=' #qoovee search
                ...
                check = True
                pass
        if len(web_soup.findAll('ol',{'class':'products'})) != 0: #class
    ...
    def fetch_data(self, web_soup, description, origin):
        ...
        list_of_products = web_soup.findAll('div', {'class':'product-item-info'}) #class
        price_list = web_soup.findAll('span',{'class':'price'})
            ...
            for Data_from_websites in list_of_products:
                ...
                if price_from_website is not None and price_from_website != '':
                    try:
                        ...
                        product_description = Data_from_websites.find('strong',{'class':'product-item-name'}).text
