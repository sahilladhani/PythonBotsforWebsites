...
class FetchProductData:
    ...
    def find_data(self, description, origin,credentials):
        ...
        while(check):
            try:
                ...
                base_url = 'https://www.daraz.pk/search/?q=' #daraz
        ...
        if len(web_soup.findAll('div',{'class':'c2prKC'})) != 0: #class
    ...
    def fetch_data(self, web_soup, description, origin):
        ...
        list_of_products = web_soup.findAll('div',{'class':'c2prKC'}) #class
        price_list = web_soup.findAll('div',{'class':'c3gUW0'}) #class
        index=0
        try:
            for Data_from_websites in list_of_products:
                ...
                if price_from_website is not None and price_from_website != '':
                    try:
                        ...
                        product_description = Data_from_websites.find('div',{'class':'c16H9d'}).text
                    ...
                    product_description = product_description.lower()
                    product_origin = Data_from_websites.find('span',{'class':'c2i43-'})
